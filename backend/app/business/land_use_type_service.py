...
class LandUseTypeService:
    ...
    def get(self, filter_map: Dict):
        ...
        if query_type == "single":
            ...
            if query_param in [el.value for el in GenericLandUseTypeEnum]:
    ...
    def get_by_name(self, land_use_type_name: str):
        ...
        if land_use_type_name in [el.value for el in SpecificLandUseTypeEnum]:
            land_use_type = self.accessor.get_specific_by_name(land_use_type_name)
        elif land_use_type_name in [el.value for el in GenericLandUseTypeEnum]:
